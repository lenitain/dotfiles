...
For composite-level diff and iteration, see `workflow/composition-bringing-layers-together.md` ("Composite Diff and Iteration" section).

For the final pixel-perfect gate, see `workflow/pixel-perfect-verification.md`.
