...
### Step 6: Pixel-perfect verification (final gate)

Read `workflow/pixel-perfect-verification.md`. The rendered SVG must match the original image pixel-for-pixel (AE = 0). This is a hard gate before delivery.
