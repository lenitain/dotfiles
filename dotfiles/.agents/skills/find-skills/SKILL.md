...
- `anthropics/skills` — Frontend design, document processing (100K+ installs) [official reference collection]
...
2. **Source reputation** — Official sources (e.g. `vercel-labs`, `anthropics`, `microsoft`) are more trustworthy than unknown authors.
