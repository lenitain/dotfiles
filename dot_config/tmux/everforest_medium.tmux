...
set -g status-right "#[fg=#2d353b,bg=#2d353b,nobold,nounderscore,noitalics]#[fg=#7fbbb3,bg=#2d353b] #{prefix_highlight} #[fg=#3a464c,bg=#2d353b,nobold,nounderscore,noitalics]#[fg=#7fbbb3,bg=#3a464c] %Y-%m-%d  %I:%M %p #[fg=#7fbbb3,bg=#3a464c,nobold,nounderscore,noitalics]#[fg=#2d353b,bg=#7fbbb3,bold] #h "
if-shell '[ "$(tmux show-option -gqv "clock-mode-style")" == "24" ]' {
  set -g status-right "#[fg=#2d353b,bg=#2d353b,nobold,nounderscore,noitalics]#[fg=#7fbbb3,bg=#2d353b] #{prefix_highlight} #[fg=#3a464c,bg=#2d353b,nobold,nounderscore,noitalics]#[fg=#7fbbb3,bg=#3a464c] %Y-%m-%d  %H:%M #[fg=#7fbbb3,bg=#3a464c,nobold,nounderscore,noitalics]#[fg=#2d353b,bg=#7fbbb3,bold] #h "
}
...
setw -g window-status-current-format "#[fg=#2d353b,bg=#3a464c,nobold,nounderscore,noitalics]#[fg=#7fbbb3,bg=#3a464c,bold] #I  #W #F #[fg=#3a464c,bg=#2d353b,nobold,nounderscore,noitalics]"
