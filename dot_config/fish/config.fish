...
function dfzf
    ...
    set target_dir (fd -t d -H | fzf --preview "bash -c 'ls -la \"{}\"'" --preview-window right:38%)
...
function pfzf
    fzf --preview "bash -c '~/.config/fish/scripts/fzf_preview.sh \"{}\"'" --preview-window=right:38%:wrap
end
